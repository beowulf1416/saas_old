create table if not exists transaction_items (
    ...
    debit decimal(12,4),
    credit decimal(12,4),
    constraint pk_transaction_items primary key (created_year, id),
    constraint fk_transaction_items_1 foreign key (client_id)
        references clients.clients (id) on delete restrict on update restrict,
    constraint fk_transaction_items_2 foreign key (created_year, transaction_id)
        references accounting.transactions (created_year, id) on delete restrict on update restrict,
